---
title: Deploy Strapi with Dokku
date: 2020-12-04
slug: /deploy-strapi-with-dokku
---
...
![](/content/images/2020/11/Dokku-DigitalOcean.png)Make sure to select a droplet with at least 2GB of RAM
...
That will expose the database port to the host so you can connect to it. Now you're ready to connect via PSequel. Simply fill in the fields and you should see your database!
![](/content/images/2020/12/Screen-Shot-2020-12-03-at-8.50.29-PM.png)PSequel screen
## Conclusion
